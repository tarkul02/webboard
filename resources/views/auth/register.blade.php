    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card bg-white">
                <div class="card-header text-white" style="background-color: #6E27B1;">{{ __('messages.Register') }}</div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{  __('validation.custom.email') }}</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{  __('validation.custom.password') }}</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
